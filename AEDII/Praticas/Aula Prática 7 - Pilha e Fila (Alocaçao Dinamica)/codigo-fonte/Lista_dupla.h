...
#include "Noh_duplo.h"
/**
 * @brief Definicao do TAD lista duplamente encadeada.
 */
typedef struct {
...
/**
 * @brief Imprime o conteudo de todos os nohs da lista, comecando pelo primeiro, ateh o ultimo. 
 * @param lista ponteiro apontando para a lista que serah impressa.
 */
void ImprimePrimeiroUltimo(lista *l);
/**
 * @brief Imprime o conteudo de todos os nohs da lista, comecando pelo ultimo, ateh o primeiro. 
 * @param lista ponteiro apontando para a lista que serah impressa.
 */
